        ...
        <div class="card-header">
          ...
          <div class="float-right">
            <form action="" method="post">
              ...
              <a href="<?=base_url('produk/kategori/tambah')?>" class="btn btn-primary">
        ...
        <table id="table1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td style="width: 10rem;">
              <form action="<?=base_url('produk/kategori/hapus')?>" method="post">
                <a class="btn btn-sm btn-outline-primary" href="<?=base_url('produk/kategori/ubah/'.$category->category_id)?>">
