...
<div class="container-fluid mt-4">
  <div class="row">
    ...
    <main class="col-md-9 ml-sm-auto col-lg-9 px-md-4">
      <h1 class="h2 text-secondary text-center border-bottom pb-3">Material List</h1>
      <div class="table-responsive">
        <div class="d-flex justify-content-between mb-3">
          ...
          <a class="btn btn-outline-primary" href="add-material.html"><i class="fas fa-plus"></i> Add Material</a>
        </div>        
