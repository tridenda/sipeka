...
class Stocks extends CI_Controller {
  ...
  function get_stock_ajax($type) {
        ...
        <a href="'.base_url('persediaan/hapus/').$stock->stock_id.'" onclick="return confirm(\'Anda akan menghapus data persediaan, yakin?\');" class="btn btn-sm btn-outline-danger"><i class="far fa-trash-alt"></i> Hapus</a>
        ';
        $data[] = $row;
    }
		$output = array(
  ...
  public function stock_in_index() {
    $data['type'] = 'in';
		$this->template->load('template', 'materials/stocks/stock-in/index', $data);
  }
  ...
  public function stock_in_add() {
    ...
    if( !isset($_POST['in_add']) ) {
      ...
      $this->template->load('template', 'materials/stocks/stock-in/form', $data);
